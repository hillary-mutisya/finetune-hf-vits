#!/usr/bin/env python3
"""
Generate comparison samples: v3 (50ep, frozen text_enc+dur_pred) vs production vs v2 vs v1
"""
...
MODELS = {
    "v3_frozen": "mutisya/vits_luo_26_05_f_v3",
...
def main():
    ...
    output_dir = Path("luo_v3_samples")
